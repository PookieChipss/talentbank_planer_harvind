...
**Live demo:** [talentbank-planer-harvind.vercel.app](https://talentbank-planer-harvind.vercel.app)
**Admin panel:** [talentbank-planer-harvind.vercel.app/admin](https://talentbank-planer-harvind.vercel.app/admin)
...
- **[Next.js](https://nextjs.org)** (App Router) — frontend and backend (API routes) in one project
- **[Supabase](https://supabase.com)** (Postgres) — database and data access
- **[Vercel](https://vercel.com)** — deployment, auto-redeploys on every push to `main`
...
Open [http://localhost:3000](http://localhost:3000) for the public calendar, or [http://localhost:3000/admin](http://localhost:3000/admin) for the admin panel.
